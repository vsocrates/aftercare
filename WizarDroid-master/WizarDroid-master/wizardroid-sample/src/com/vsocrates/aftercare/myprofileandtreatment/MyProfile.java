...
import com.vsocrates.aftercare.*;
import com.vsocrates.aftercare.main.*;

public class MyProfile extends WizardActivity {
    ...
    public void onSetup(WizardFlow flow) {
        flow = new WizardFlow.Builder()
                ...
                .addStep(MyProfileStep1.class)                   //Add your steps in the order you want them
                .addStep(MyProfileStep2.class)
                .addStep(MyProfileStep3.class)
                .addStep(MyProfileStep4.class)
                .addStep(MyProfileSummary.class)
                		//to appear and eventually call create()
